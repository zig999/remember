...
> Stack: Node.js 20 LTS + TypeScript strict + Fastify | DB: PostgreSQL 17 via Neon (managed Postgres, driver `pg` raw) | Version: 1.2.0 | Status: draft | Layer: permanent
