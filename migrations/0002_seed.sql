-- ============================================================================
-- 0002_seed.sql — Segundo Cérebro (spec v6, 2026-06-11)
-- Catálogo seed obrigatório (§15): 8 NodeTypes, 10 LinkTypes (+22 regras),
-- 10 AttributeKeys. Novos tipos entram por migração versionada (§12).
-- ============================================================================
