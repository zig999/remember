...
-- =============================================================================
-- Copied/adapted from the spec artifact at
-- `docs/specs/domains/chat/back/0004_chat_persistence.sql` (chat.back.md v2.0.0
-- §2). DO NOT apply against any database without explicit owner approval
